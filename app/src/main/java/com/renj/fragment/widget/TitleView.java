package com.renj.fragment.widget;
...
public class TitleView extends RelativeLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        if (backIcon == null) {
            backIcon = resources.getDrawable(R.mipmap.title_view_back, null);
        }

        titleContent = typedArray.getString(R.styleable.TitleView_title_view_title);
        titleTextSize = typedArray.getDimension(R.styleable.TitleView_title_view_titleSize, resources.getDimension(R.dimen.title_text_size));
        titleTextColor = typedArray.getColor(R.styleable.TitleView_title_view_titleColor, resources.getColor(R.color.color_main_text));

        rightText = typedArray.getString(R.styleable.TitleView_title_view_right_text);
        rightTextSize = typedArray.getDimension(R.styleable.TitleView_title_view_right_textSize, resources.getDimension(R.dimen.default_text_size));
        rightTextColor = typedArray.getColor(R.styleable.TitleView_title_view_right_textColor, resources.getColor(R.color.color_gray_text));
        ...
        bottomLineColor = typedArray.getColor(R.styleable.TitleView_title_view_bottom_line_color, resources.getColor(R.color.color_line_bg));
        typedArray.recycle();
    }

    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.common_title_view, this, true);
