 ...
 * ======================================================================
 */
class AddFragment1 : LazyFragment() {
    ...
    override fun initData(rootView: View?, arguments: Bundle?) {
        llContent.setBackgroundColor(ResUtils.getColor(R.color.color_content_bg_one))
        tvContent.text = ResUtils.getString(R.string.add_fragment1)
    }
}